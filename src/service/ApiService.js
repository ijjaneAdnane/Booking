...
export default class ApiService {
    ...
    static async cancelBooking(bookingId) {
     ...
     /**PAYMENT */
     static async createPaymentIntent(paymentInfo) {
        const response = await axios.post(`${this.BASE_URL}/api/payment/secure/payment-intent`, paymentInfo, {
            headers: this.getHeader()
        });
        return response.data;
    }

    static async completePayment(token) {
        const response = await axios.put(`${this.BASE_URL}/api/payment/secure/payment-complete`, {}, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
